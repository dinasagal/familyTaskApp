...
This app uses Firebase security best practices:
- **Firestore Security Rules**: Role-based access control (see `FIRESTORE_RULES.txt`)
- **Protected Configuration**: Firebase credentials in gitignored file
- **Family-Based Isolation**: Users only access their own family data

📖 **For detailed security information and setup, see [SECURITY.md](SECURITY.md)**
...
4. **Configure Firebase in Your App**
   ...
   - Open `firebase.config.js` and add your Firebase project credentials:
   ```javascript
